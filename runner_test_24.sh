...
python3 /home/hpc/iwfa/iwfa024h/Multi_Label_optical_Segmentation/train_net.py \
    ...
    --DILATE=0 \
    --EPOCHS=150 \
    --LEARNING_RATE=0.9820380617579696\
    --DELTA_CLS_LOSS=0.0010184588747592263\
    --BATCH_SIZE=1 \
    ...
    --DEC_OUTSIZE=12 \
    --DOWN_FACTOR=8 \
    --SPLIT_LOCATION=/home/hpc/iwfa/iwfa024h/Multi_Label_optical_Segmentation/splits/PA_M/split_24_D2.pyb \
    --MULTISEG=True \
    --MULTIDEC=True \
    --CLASSWEIGHTS=False